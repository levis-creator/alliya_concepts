...
import serviceImage from "../assets/AdobeStock_308590206_Preview-transformed-removebg-preview.png";
      ...
      <div className="w-full  min-h-screen pt-20 md:pt-0">
        <section className="md:h-screen md:relative md:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
          <div className="md:w-3/6 md:absolute md:bottom-16">
            <h2 className="font-bold text-3xl px-7 md:text-6xl md:text-white">
              {" "}
              Our services
            </h2>
          ...
          <div className="  md:absolute md:bottom-16 md:right-0">
